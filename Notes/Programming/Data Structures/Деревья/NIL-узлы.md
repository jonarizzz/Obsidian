**NIL-узлы** — это фиктивные узлы, которые используются в [[Красно-чёрное дерево (Red-Black Tree)||красно-чёрных деревьях]] для упрощения реализации и обеспечения соблюдения всех их свойств.
